const {create,getUserByUserEmail,getRegisterMedicalRecord,UpdateRegisterEmergency,getUserDetailsByImage,registerEmergency,getUpdateMedicalRecord, }=require('./user.service');
